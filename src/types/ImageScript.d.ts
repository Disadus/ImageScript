...
export class Image {
     ...
     */
    encode(compression?: number, { title, author, description, copyright, creationTime, software, disclaimer, warning, source, comment }?: {
        /**
         * The images title
         */
        title?: string;
...
export class Frame extends Image {
     ...
     * @return {Frame}
     */
    static from(image: Image, duration?: number, xOffset?: number, yOffset?: number, disposalMode?: string | number): Frame;
    /**
     ...
     * @return {Frame}
     */
    constructor(width: number, height: number, duration?: number, xOffset?: number, yOffset?: number, disposalMode?: string | number);
    duration: number;
    xOffset: number;
    yOffset: number;
