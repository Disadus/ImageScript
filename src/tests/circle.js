...
(async () => {
    {
        ...
        if (process.env.OVERWRITE_TEST)
            await fs.writeFile('./src/tests/targets/circle.png', encoded);

        const target = await fs.readFile('./src/tests/targets/circle.png');
...

    {
        ...
        if (process.env.OVERWRITE_TEST)
            await fs.writeFile('./src/tests/targets/circle2.png', encoded);

        const target = await fs.readFile('./src/tests/targets/circle2.png');
...

    {
        ...
        if (process.env.OVERWRITE_TEST)
            await fs.writeFile('./src/tests/targets/circle3.png', encoded);

        const target = await fs.readFile('./src/tests/targets/circle3.png');
...

    {
        ...
        if (process.env.OVERWRITE_TEST)
            await fs.writeFile('./src/tests/targets/circle4.png', encoded);

        const target = await fs.readFile('./src/tests/targets/circle4.png');
